...
- 🟨 CI (GitHub Actions) ✅ + deploy config ready (Docker/Vercel, guide 23) + go live + screenshots (pending)
...
- 🟨 CI (GitHub Actions) ✅ + config de deploy lista (Docker/Vercel, guía 23) + publicar + capturas (pendiente)
