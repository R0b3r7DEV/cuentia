...
class InvoiceController extends AbstractController
{
    ...
    public function create(Request $request, InvoiceService $service, #[CurrentUser] User $user): JsonResponse
    {
        ...
        return $this->json($this->detail($invoice), 201);
    }

    #[Route('/api/invoices/{id}', name: 'api_invoices_get', methods: ['GET'])]
    public function get(int $id, InvoiceRepository $repo, #[CurrentUser] User $user): JsonResponse
    {
        ...
        return $this->json($this->detail($invoice));
    }
